        ...
        <div class="relative bg-white shadow-xl">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3">
                ...
                <div class="relative overflow-hidden py-10 px-6 bg-indigo-700 sm:px-10 xl:p-12">
                    ...
                    <p class="mt-6 text-base text-indigo-50 max-w-3xl">Gear Depot, is a product developed and maintained by Be IT Safe</p>
                    <dl class="mt-8 space-y-6">
                        ...
                        <dd class="flex text-base text-indigo-50">
                            ...
                            <span class="ml-3"><a href="tel:1300604814">1300 604 814</a></span>
                        </dd>
                        ...
                        <dd class="flex text-base text-indigo-50">
                            ...
                            <span class="ml-3"><a href="mailto:info@geardepot.com.au">info@geardepot.com.au</a></span>
                        </dd>
                    </dl>
